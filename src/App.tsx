            ...
            <aside className={`lg:w-64 bg-[#0f172a] text-slate-300 lg:sticky lg:top-14 lg:h-[calc(100vh-56px)] select-none shrink-0 border-r border-slate-900 flex flex-col justify-between p-4 ${mobileSbarOpen ? 'block fixed inset-y-14 left-0 z-50 w-64' : 'hidden lg:flex'}`}>
                  ...
                  {permittedMenus.map(menu => {
                    ...
                    return (
                      <button 
                        ...
                        className={`w-full text-left px-3.5 py-3 rounded-xl text-xs font-bold transition-all duration-150 flex items-center justify-between group cursor-pointer border ${
                          isActive 
                            ? 'bg-gradient-to-r from-indigo-600 to-indigo-700 text-white border-indigo-500 shadow-md shadow-indigo-600/20' 
                            : 'bg-transparent text-[#94a3b8] border-transparent hover:bg-slate-900 hover:text-white hover:border-slate-800'
                        }`}
                      >
                        <div className="flex items-center space-x-3 truncate">
                          <span className={`p-1.5 rounded-lg transition-colors duration-150 ${
                        ...
                        {badgeCount > 0 ? (
                          <span className={`px-2 py-0.5 rounded-full text-[9px] font-extrabold ${badgeBg}`}>
                            {badgeCount}
                          </span>
                        ) : isActive ? (
              ...
              <div className="pt-4 border-t border-slate-900 space-y-3">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-rose-600/10 hover:bg-rose-600 text-rose-400 hover:text-white rounded-xl text-xs font-extrabold flex items-center justify-center space-x-2.5 transition-all duration-200 border border-rose-500/30 hover:border-rose-600 active:scale-[0.98] cursor-pointer shadow-3xs"
