          ...
          <div className="grow flex flex-col lg:flex-row">
            ...
            <aside className={`lg:w-64 bg-[#0f172a] text-slate-300 lg:sticky lg:top-14 lg:h-[calc(100vh-56px)] select-none shrink-0 border-r border-slate-900 flex flex-col justify-between p-4 ${mobileSbarOpen ? 'block fixed inset-y-14 left-0 z-50 w-64' : 'hidden lg:flex'}`}>
              ...
              <div className="pt-4 border-t border-slate-900 space-y-2">
                <div className="bg-slate-900/40 p-2.5 rounded-lg text-[10px] text-slate-400 text-center font-normal">
                  📰 {activeChurch?.name || 'Synode Admin Sektor'}
                </div>
                <button 
                  onClick={handleLogout}
                  className="w-full py-2 bg-slate-900/80 hover:bg-rose-950 hover:text-rose-400 text-slate-400 rounded-lg text-xs font-semibold flex items-center justify-center space-x-1.5 transition"
                >
